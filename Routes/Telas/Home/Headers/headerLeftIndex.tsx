                                        ...
                                        {usuario === null ?
                                            ...
                                            >
                                                <View style={[Styles.em_linhaHorizontal, { justifyContent: 'flex-start' }]}>
                                                    <Image source={{ uri: usuario !== null && usuario.imagem !== undefined ? Config.configuracoes.pathPadrao + '/src/' + usuario.imagem : 'https://gsapp.com.br/favicon.ico' }} style={[styles.avatar, Styles.mr_5, { width: 45, height: 45, resizeMode: 'stretch' }]} />
