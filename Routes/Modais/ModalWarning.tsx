    ...
    try {
      ...
      >
        <View style={Styles.centeredView}>
          ...
          <View style={[Styles.modalView,getModalStyle('warning')]}>
            {
              titleModal !== '' &&

              <View style={[Styles.em_linhaHorizontal,Styles.w100,{marginHorizontal:0,paddingHorizontal:0,alignItems:'center',justifyContent:'space-between',borderBottomWidth:1,borderBottomColor:'#9999',paddingVertical:5}]}>
                <View style={[Styles.em_linhaHorizontal,Styles.w90,{marginHorizontal:0,paddingHorizontal:0,alignItems:'center',justifyContent:'flex-start',}]}>
                  <MaterialCommunityIcons name={iconeModal === '' ? 'help' : iconeModal} size={25} style={[Styles.mr_5,getModalStyleLabel('warning'),]}/>
                  <Text style={[Styles.ft_bold,getModalStyleLabel('warning'),]}>{titleModal}</Text>
                </View>
                <TouchableOpacity
      ...
      Alert.alert('Erro de inicio','Corrija o erro na linha 55 do modalWarning=>',error.message)
    }
