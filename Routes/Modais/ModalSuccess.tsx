    ...
    try {
      ...
      >
        <View style={Styles.centeredView}>
          ...
          <View style={[Styles.modalView,getModalStyle('success')]}>
            {
              titleModal !== '' &&
              ...
              <View style={[Styles.em_linhaHorizontal,Styles.w100,{marginHorizontal:0,paddingHorizontal:5,alignItems:'center',justifyContent:'flex-start',borderBottomWidth:1,borderBottomColor:'#9999',paddingVertical:5}]}>
                <View style={[Styles.em_linhaHorizontal,Styles.w90,{marginHorizontal:0,paddingHorizontal:5,alignItems:'center',justifyContent:'flex-start'}]}>
                  <MaterialCommunityIcons name={iconeModal === '' ? 'help' : iconeModal} size={25} style={[Styles.mr_5,getModalStyleLabel('success'),]}/>
                  <Text style={[Styles.ft_bold,getModalStyleLabel('success'),]}>{titleModal}</Text>
                </View>
                <TouchableOpacity 
      ...
      Alert.alert('Erro de inicio','Corrija o erro na linha 55 do modalSuccess=>',error.message)
    }
