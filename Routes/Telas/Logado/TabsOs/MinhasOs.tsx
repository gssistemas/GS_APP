                  ...
                  return(
                    <ThemedView>
                      <ThemedView style={[{width:width,marginTop:0,flexDirection:'row',alignItems:'center',justifyContent:'space-between',borderBottomWidth:1,borderBottomColor:'#999',paddingVertical:7,backgroundColor:theme.backgroundColor.background}]}>
                        <ThemedText type='defaultSemiBold' style={[Styles.w75,{marginHorizontal:0,marginLeft:'2.5%'/*borderBottomWidth:1,borderBottomColor:'#999999'*/}]}>{listMinhasOs !== null && listMinhasOs !== undefined && listMinhasOs.length > 0 ? listMinhasOs.length+'-': ''}Ordens de serviço</ThemedText>
                        <TouchableOpacity
